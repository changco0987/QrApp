...
<body>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="d-block" src="../asset/pic1.jpg" alt="First slide" style="width: 100%; height: 857px;">
                    ...
                    <div class="carousel-item">
                        <img class="d-block img-responsive" src="../asset/sti.jpg" alt="Second slide" style="width: 100%; height: 857px;">
                        <div class="carousel-caption">
                    ...
                    <div class="carousel-item">
                        <img class="d-block img-responsive" src="../asset/pic3.jpeg" alt="Third slide" style="width: 100%; height: 857px;">
                        <div class="carousel-caption">
            ...
            <div class="container pagination-centered text-center mx-auto pt-5 mt-5" style="background-color: #F1F1F1; border-radius: 20px; box-shadow: -2px 2px 18px 4px black;">
                ...
                <div class="row no-gutters d-flex justify-content-center mb-5 px-2 mx-2 pt-5 mt-5">
                    ...
                    <div class="col-sm-12 col-xs-12 col-md-12 pt-2 mt-2 d-flex justify-content-center">
                        <button type="button" class="btn btn-lg mx-auto pl-3" id="myBtn" style="width: 150px; background-color: #3466AA; color:white;">Visitor</button>
                        <button type="button" class="btn btn-lg mx-auto pr-3" style="width: 150px; background-color:#114084; color:white;">Guardian</button>
                    </div>
                    <div class="col-sm-12 col-xs-12 col-md-12 pt-2 mt-2 pb-5 mb-5 d-flex justify-content-center">

                        <h5 class="ml-2 pl-2" style="font-size: 13px;">Don't have any account? <a class="text-primary" href="../page/signup.php">Click here</a></h5>
    ...
    <div class="row no-gutters align-items-end" style="background-color: #9C9C9C;">
        <div class="d-flex justify-content-center col-sm-12 col-xs-12 col-md-12 pb-2 mb-2 pt-3 mt-3">
