...
<body>
    ...
    <div class="row no-gutters">
        ...
        <div class="col-sm-4 col-xs-4 col-md-4 col-lg-4 px-2 py-5">
            <div class="container pagination-centered text-center mx-auto pt-5 mt-5" style="background-color: #F1F1F1; border-radius: 15px; ">
                <div class="row no-gutters d-flex">
                    <div class="col-sm-12 col-xs-12 col-md-12">
                            <hr style="height:2px;border-width:0;color:gray;background-color:gray">
                        <h1 id="pageTitle" class="pt-2 mt-2">QR Code Based Health Monitoring System</h1>
                            <hr style="height:2px;border-width:0;color:gray;background-color:gray">
                    </div>
                </div>
